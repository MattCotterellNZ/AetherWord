...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: 'Content/style.css', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			'wide': { range: '-1920', href: 'Content/style-wide.css', containers: 1360 },
			'normal': { range: '-1680', href: 'Content/style-normal.css', containers: 1200 },
			'narrow': { range: '-1280', href: 'Content/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: 'Content/style-narrower.css', containers: '95%' },
			'mobile': { range: '-736', href: 'Content/style-mobile.css', grid: { gutters: 20 } },
